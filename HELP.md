...
* The original package name 'com.progettodogsitting.dogsitting-backend' is invalid and this project uses 'com.progettodogsitting.dogsitting_backend' instead.
